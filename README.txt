...
* Como evaluaría el desempeño del bot: 
    ...
    También luego de haber finalizado la conversación (1 o 2 horas o mas desde que el chatbot no interactua con el usuario), enviaría una encuesta para que la persona pueda dar su opinión o feedback.
...
* ⁠Manual para que cualquier persona pueda instalar el bot. 
    ...
    - Crear una cuenta de Twilio y setear un numero de prueba. En el siguiente link se detalla muy concisamente como hacerlo: https://www.youtube.com/watch?v=UVez2UyjpFk . De este paso obtendremos la variable TWILIO_NUMBER = "+123456789" (importante el numero). También deberemos setear la variable ACCOUNT_SID y AUTH_TOKEN con los valores que se encuentran en el inicio.
...
* Diagrama de prompts. 
    ...
    Otros enfoques que se podrían hacer para obtener la variable {kavak_cars_data} es usar una openai tool function que haga una peticion a una base de datos o backend de la pagina que tenga la informacion de los autos disponibles.

    La variable {kavak_business_data} es toda la descripcion que se encuentra en la pagina https://www.kavak.com/mx/blog/sedes-de-kavak-en-mexico. Esto tambien se podria resolver haciendo un get a la pagina y, localizando el html, obtener todo el texto para agregarlo al prompt.
